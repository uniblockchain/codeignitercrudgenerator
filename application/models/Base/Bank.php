...
abstract class Bank implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\BankTableMap';
    ...
    /**
     * The value for the pemilik field.
     *
     * @var        string
     */
    protected $pemilik;
    ...
    /**
     * Initializes internal state of Base\Bank object.
     */
    ...
    public function setNama($v)
    {
        ...
        if ($this->nama !== $v) {
            $this->nama = $v;
            $this->modifiedColumns[BankTableMap::COL_NAMA] = true;
        }
    ...
    /**
     * Set the value of [norek] column.
     *
     * @param string $v new value
     * @return $this|\Bank The current object (for fluent API support)
     */
    public function setNorek($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }
        ...
        if ($this->norek !== $v) {
            $this->norek = $v;
            $this->modifiedColumns[BankTableMap::COL_NOREK] = true;
        }
    ...
    /**
     * Set the value of [pemilik] column.
     *
     * @param string $v new value
     * @return $this|\Bank The current object (for fluent API support)
     */
    public function setPemilik($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }
        ...
        if ($this->pemilik !== $v) {
            $this->pemilik = $v;
            $this->modifiedColumns[BankTableMap::COL_PEMILIK] = true;
        }
    ...
    public function setStatus($v)
    {
        ...
        if ($this->status !== $v) {
            $this->status = $v;
            $this->modifiedColumns[BankTableMap::COL_STATUS] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : BankTableMap::translateFieldName('Nama', TableMap::TYPE_PHPNAME, $indexType)];
            $this->nama = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : BankTableMap::translateFieldName('Norek', TableMap::TYPE_PHPNAME, $indexType)];
            $this->norek = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : BankTableMap::translateFieldName('Pemilik', TableMap::TYPE_PHPNAME, $indexType)];
            $this->pemilik = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : BankTableMap::translateFieldName('Status', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(BankTableMap::COL_NAMA)) {
            $modifiedColumns[':p' . $index++]  = 'nama';
        }
        if ($this->isColumnModified(BankTableMap::COL_NOREK)) {
            $modifiedColumns[':p' . $index++]  = 'norek';
        }
        if ($this->isColumnModified(BankTableMap::COL_PEMILIK)) {
            $modifiedColumns[':p' . $index++]  = 'pemilik';
        }
        if ($this->isColumnModified(BankTableMap::COL_STATUS)) {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'nama':
                        ...
                        break;
                    case 'norek':
                        $stmt->bindValue($identifier, $this->norek, PDO::PARAM_STR);
                        break;
                    case 'pemilik':
                        $stmt->bindValue($identifier, $this->pemilik, PDO::PARAM_STR);
                        break;
                    case 'status':
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array())
    {
        ...
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getNama(),
            $keys[2] => $this->getNorek(),
            $keys[3] => $this->getPemilik(),
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[2], $arr)) {
            $this->setNorek($arr[$keys[2]]);
        }
        if (array_key_exists($keys[3], $arr)) {
            $this->setPemilik($arr[$keys[3]]);
        }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(BankTableMap::COL_NAMA)) {
            $criteria->add(BankTableMap::COL_NAMA, $this->nama);
        }
        if ($this->isColumnModified(BankTableMap::COL_NOREK)) {
            $criteria->add(BankTableMap::COL_NOREK, $this->norek);
        }
        if ($this->isColumnModified(BankTableMap::COL_PEMILIK)) {
            $criteria->add(BankTableMap::COL_PEMILIK, $this->pemilik);
        }
        if ($this->isColumnModified(BankTableMap::COL_STATUS)) {
            $criteria->add(BankTableMap::COL_STATUS, $this->status);
        }
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setNorek($this->getNorek());
        $copyObj->setPemilik($this->getPemilik());
